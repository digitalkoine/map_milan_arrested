...
function style_convoy_11(feature) {
return {
pane: 'pane_jsonLayer_convoy',
opacity: 1,
...
function style_convoy_20(feature) {
return {
pane: 'pane_jsonLayer_convoy',
opacity: 1,
...
var jsonLayer_convoy_5 = L.geoJson(convoy_5,{
  onEachFeature: function(feature, layer) {
    ...
    layer.bindPopup(
      ...
      '<br>'+'Lista: '+feature.properties.list_arrestati_milano+
      '</p>'
      );
...
var jsonLayer_convoy_11 = L.geoJson(convoy_11,{
  onEachFeature: function(feature, layer) {
    var prevLayerClicked = null
    layer.bindPopup(
      '<p>'+'<strong>'+'Convoglio numero: '+feature.properties.convoyNumber+'</strong>'+
...
var jsonLayer_convoy_19 = L.geoJson(convoy_19,{
  onEachFeature: function(feature, layer) {
    ...
    layer.bindPopup(
      '<p>'+'<strong>'+'Convoglio numero: '+feature.properties.convoyNumber+'</strong>'+
      '<p>'+feature.properties.description+
      '<br>'+'Lista: '+feature.properties.list_arrestati_milano_arresti_milano+
      '</p>'
      );
      layer.setStyle({weight: feature.properties.quantity/2})
    },
...
var jsonLayer_convoy_20 = L.geoJson(convoy_20,{
  onEachFeature: function(feature, layer) {
    var prevLayerClicked = null
    layer.bindPopup(
      '<p>'+'<strong>'+'Convoglio numero: '+feature.properties.convoyNumber+'</strong>'+
