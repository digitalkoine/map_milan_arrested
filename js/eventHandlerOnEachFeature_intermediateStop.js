...
function eventHandlerOnEachFeature_intermediateStop(feature, layer) {
    ...
    layer.bindPopup(
      '<h3>'+'<strong>'+'Stazione di Verona'+'</strong>'+'</h3>'+
      '<p>'+'<strong>'+feature.properties.quantity+'</strong>'+' persone dal nostro dataset sono transitate dalla stazione di Verona tra '+
